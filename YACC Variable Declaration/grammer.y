...
;
forint: INT varint DL NL {printf("Valid integer declaration\n"); return 0;}
;
forfloat: FLOAT varfloat DL NL {printf("Valid float declaration\n"); return 0;}
;
forchar: CHAR varchar DL NL {printf("Valid char declaration\n"); return 0;}
;
forbool: BOOL varbool DL NL {printf("Valid boolean declaration\n"); return 0;}
;
